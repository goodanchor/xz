...
<div id="wrapper">
    <div id="header" class="clearfix">
        <a class="logo-bar"><img src="./public/img/logo.png" class="img"></a>
    ...
    <div id="content" class="clearfix">
        ...
        <div class="main">
            <div class="personal-bar">
                <div class="row">
                    <a class="nav active" href="#">我的消息</a>
                    <a class="nav" href="#">我发布的商品</a>
                    <a class="nav" href="#">我的收藏</a>
                </div>
                <div class="basic">
                    <img class="img inline-block" src="img/head.jpg">
                    <form action="" class="inline-block">
                        <div class="margin">
                            <label for="name">昵称</label><input type="text" class="input-text" id="name">
                        </div>
                        <div class="margin">
                            <label for="qnum">QQ号</label><input type="text" class="input-text" id="qnum">
                        </div>
                        <div class="margin">
                            <label for="tel">手机号</label><input type="text" class="input-text" id="tel">
                        </div>
                    </form>
                    <a class="edit-btn f12"><span class="inline-block"></span>确认修改</a>
                </div>
            </div>
        </div>
        <div class="right-bar">
            ...
            <ul class="like-list">
                ...
                <li>
                    <a class="pro-item">
                        <img src="./public/img/example.jpg" class="img">
                        <div class="basic-bar">
