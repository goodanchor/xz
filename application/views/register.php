...
<div id="wrapper">
    <div class="login-bar">
        ...
        <div class="right-bar inline-block">
            <div class="nav-bar">
                <a class="nav active" href="#">新用户注册</a>
                <a class="nav" href="#">登录</a>
            ...
            <form class="login-form">
                ...
                <div class="row">
                    ...
                    <input type="text" class="input-text" id="repassword">
                </div>
                <div class="margin">
                    <input class="inline-block btn login-btn" type="submit" value="注册">
                </div>
            </form>
        </div>
    </div>
